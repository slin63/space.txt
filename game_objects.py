...
class Player(object):
    def __init__(self, name, health, inventory=None, position=None):
        self.name = name
        self.health = health
    ...
    def get_surroundings(self, vision, objects):
        ...
        for e in objects.keys():
            d = pos.distance(e)
            if d <= vision:
                in_range += ((objects[e], d, {pos.theta(e):pos.cardinality(e)}), )
...
#
obj_test = {
    C(0, 0): 'STAR322B', C(4, 15): 'WRECK', C(12, 5): 'SAT', C(6, 15): 'SAT',
    C(12, 14): 'STAR353A', C(2, 18): 'WRECK', C(14, 9): 'DEBRIS', C(10, 2): 'WRECK', C(13, 1): 'DEBRIS', C(12, 7): 'DEBRIS'
}
p = Player("p", 100, position=C(0,0))
# print p.get_position()
print p.get_surroundings(15, obj_test)
